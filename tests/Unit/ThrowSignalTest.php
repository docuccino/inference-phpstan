 ...
 * of "not written here", "not declared by the application" and "no status anyone could read" hold at once.
 *
 ...
 */
it('demotes only a foreign declaration whose status fell back', function (bool $isLiteral, bool $calleeIsApplication, bool $fellBack, ThrowDisposition $expected): void {
    expect(ThrowSignal::disposition($isLiteral, $calleeIsApplication, $fellBack))->toBe($expected);
})->with([
    ...
    'written here, application callee, status read' => [true, true, false, ThrowDisposition::Signal],
    'written here, application callee, status fell back' => [true, true, true, ThrowDisposition::Signal],
    'declared by the application, status read' => [false, true, false, ThrowDisposition::Signal],
    'declared by the application, status fell back' => [false, true, true, ThrowDisposition::Signal],
